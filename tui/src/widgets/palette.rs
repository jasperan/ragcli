    ...
    pub fn new() -> Self {
        let actions = vec![
            PaletteAction {
                ...
                description: "Start a new RAG query".into(),
                tab_index: Some(0),
            },
            PaletteAction {
                label: "Upload Document".into(),
                description: "Upload a file to the knowledge base".into(),
                tab_index: Some(4),
            },
            PaletteAction {
                label: "View Heatmap".into(),
                description: "Visualize embedding vectors".into(),
                tab_index: Some(1),
            },
            PaletteAction {
                label: "Explore Graph".into(),
                description: "Browse knowledge graph entities".into(),
                tab_index: Some(2),
            },
            PaletteAction {
                label: "Agent Trace".into(),
                description: "View CoT reasoning pipeline".into(),
                tab_index: Some(3),
            },
            PaletteAction {
                label: "Browse Documents".into(),
                description: "Manage uploaded documents".into(),
                tab_index: Some(4),
            },
            PaletteAction {
                label: "System Status".into(),
                description: "Check service health".into(),
                tab_index: Some(5),
            },
            PaletteAction {
                label: "Refresh Data".into(),
                description: "Force-refresh all views".into(),
                tab_index: None,
            },
            PaletteAction {
            ...
            PaletteAction {
                label: "Search Entities".into(),
                description: "Find entities in the knowledge graph".into(),
                tab_index: Some(2),
            },
        ];
