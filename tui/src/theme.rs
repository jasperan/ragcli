...
impl Theme {
    pub const PRIMARY: Color = Color::Rgb(45, 212, 191); // #2dd4bf
    pub const SECONDARY: Color = Color::Rgb(56, 189, 248); // #38bdf8
    pub const ACCENT: Color = Color::Rgb(15, 23, 42); // #0f172a
